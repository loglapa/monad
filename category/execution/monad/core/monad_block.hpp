...
static_assert(sizeof(MonadConsensusBlockHeaderV0) == 1264);
static_assert(alignof(MonadConsensusBlockHeaderV0) == 8);

static_assert(sizeof(MonadConsensusBlockHeaderV1) == 1224);
static_assert(alignof(MonadConsensusBlockHeaderV1) == 8);

static_assert(sizeof(MonadConsensusBlockHeaderV2) == 1248);
...
static_assert(sizeof(MonadConsensusBlockV0) == 1336);
static_assert(alignof(MonadConsensusBlockV0) == 8);

static_assert(sizeof(MonadConsensusBlockV1) == 1296);
static_assert(alignof(MonadConsensusBlockV1) == 8);

static_assert(sizeof(MonadConsensusBlockV2) == 1320);
